...
int main(int argc, char **argv)
{
    ...
    Table *xs_tbl = Table::fr_csv("data/tasks-example.csv");
    ...
    Table *locs_tbl = Table::fr_csv("data/locs-example.csv");
    ...
    // Model:
    {
        ...
        fr_loc_idx = xs_tbl->get_column_idx("fr_loc") + ACTCOD_TYP_EMBG_DIM_CNT - 1;
